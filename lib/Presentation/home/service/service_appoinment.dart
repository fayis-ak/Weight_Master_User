...
class ServiceAppoinmentPage extends StatelessWidget {
  ServiceAppoinmentPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Service Appoinment'),
                      ...
                      if (_formKey.currentState!.validate()) {
                        if (selectedItemData != null && selectedDate != null) {
                          DBService()
                              .addAppoinment(
                                  ServiceModel(
                                    compalaint: complaintController.text,
